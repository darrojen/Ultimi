...
//   const calendarDays = useCalendarData(selectedYear, selectedMonth, activityData)
...
//   if (loading) {
//     return (
//       <Card className={`bg-white dark:bg-black/40 border ${theme === 'custom' ? 'border-blue-400' : theme === 'light' ? 'border-gray-200' : 'border-cyan-500/30'} shadow-md rounded-2xl  mb-[300px] sm:mb-[0px]`}>
//         <CardHeader>
...
//   return (
//     <Card className={`bg-white dark:bg-black/40 border ${theme === 'custom' ? 'border-blue-400' : theme === 'light' ? 'border-gray-200' : 'border-cyan-500/30'} shadow-md rounded-2xl`}>
//       <CardHeader>
//         <CardTitle className={`text-xl sm:text-2xl font-bold bg-gradient-to-r ${theme === 'custom' ? 'from-blue-400 to-blue-600' : theme === 'light' ? 'from-blue-600 to-indigo-600' : 'from-cyan-400 to-fuchsia-500'} bg-clip-text text-transparent`}>
//           Quiz Activity Calendar
//         </CardTitle>
...
//         <Box as="div" className="flex flex-wrap gap-1 sm:gap-2 mb-4 justify-center">
...
//         {/* Color Key */}
//         <Box as="div" className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mb-4">
//           <Box as="span" className={`text-sm ${theme === 'custom' ? 'text-gray-700' : theme === 'light' ? 'text-gray-700' : 'text-cyan-300'}`}>Quiz Activity Key:</Box>
...
//                 />
//                 <Box as="span" className={`text-xs ${theme === 'custom' ? 'text-gray-700' : theme === 'light' ? 'text-gray-700' : 'text-cyan-300'}`}>
...
//             {months.map((month) => (
//               <CarouselItem key={month.index} className="pl-1 sm:pl-4 md:basis-1/3 lg:basis-1/4">
//                 <Box as="div" className="p-2 sm:p-4">
//                   <Box as="h4" className={`text-center mb-2 text-sm sm:text-base ${theme === 'custom' ? 'text-gray-900' : theme === 'light' ? 'text-gray-900' : 'text-cyan-300'}`}>
//                     {month.name} {selectedYear}
//                   </Box>
//                   <Box className="grid grid-cols-7 gap-0.5 sm:gap-1 text-xs">
//                     {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map((day) => (
//                       <Box as="div" key={day} className={`text-center py-1 ${theme === 'custom' ? 'text-gray-900' : theme === 'light' ? 'text-gray-900' : 'text-cyan-300'}`}>
//                         {day}
//                       </Box>
//                     ))}
...
//                       <Box as="div"
//                         key={index}
//                         className={`w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center rounded-sm text-xs ${theme === 'custom' ? 'text-gray-900' : theme === 'light' ? 'text-gray-900' : 'text-white'} ${
...
//             ))}
//           </CarouselContent>
//           <CarouselPrevious className={`h-8 w-8 p-1 ${theme === 'custom' ? 'bg-white border-blue-400 text-blue-400 hover:bg-blue-500 hover:text-white' : theme === 'light' ? 'bg-white border-gray-300 text-gray-900 hover:bg-blue-500/80 hover:text-white' : 'bg-black/50 border-cyan-500/30 text-cyan-400 hover:bg-cyan-500/80 hover:text-black'}`} />
//           <CarouselNext className={`h-8 w-8 p-1 ${theme === 'custom' ? 'bg-white border-blue-400 text-blue-400 hover:bg-blue-500 hover:text-white' : theme === 'light' ? 'bg-white border-gray-300 text-gray-900 hover:bg-blue-500/80 hover:text-white' : 'bg-black/50 border-cyan-500/30 text-cyan-400 hover:bg-cyan-500/80 hover:text-black'}`} />
//         </Carousel>
//       </CardContent>
//     </Card>
//   )
