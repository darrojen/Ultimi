...
//     };
//     handleQuizSubmission();
//   }, [isSubmitted, calculateScores, currentSubject, userAnswers, examType, router]);
...
//             <Sheet>
//               <SheetTrigger asChild>
//                 <Button className="cursor-pointer" variant="default" size="icon" disabled={isSubmitted}>
//                   <Calculator className="w-5 h-5" />
//                 </Button>
//               </SheetTrigger>
//               <SheetContent side="right" className="w-72">
...
//                     border transition-colors duration-200
//                     ${isAnswered ? 'bg-blue-600 text-white border-blue-600' : 'bg-gray-100 text-gray-400 border-gray-300'}
//                     ${isCurrent ? 'ring-2 ring-blue-400' : ''} ${isSubmitted ? 'cursor-not-allowed opacity-50' : ''}`}
//                   onClick={isSubmitted ? undefined : () => jumpToQuestion(idx)}
//                 >
//                   {idx + 1}
//                 </div>
//               );
...
//             className="flex cursor-pointer items-center justify-center gap-2 disabled:opacity-50"
//           >
//             {saving && <Loader2 className="h-4 w-4 animate-spin" />}
//             Submit Quiz
//           </Button>
  ...
  useEffect(() => {
    ...
    const handleQuizSubmission = async () => {
      try {
        ...
        if (!prevSubmission) {
          // Clear fetched questions cache after quiz
